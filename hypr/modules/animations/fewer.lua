-- Fewer (Ultimate Productivity Animation Setup with Maximum Speed in Mind)
hl.curve("fewer", { type = "bezier", points = { { 0.05, 0.9 }, { 0.1, 1 } } })

-- Animation Behaviours
hl.animation({ leaf = "windows", enabled = true, speed = 6, bezier = "fewer" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 6, bezier = "fewer" })
